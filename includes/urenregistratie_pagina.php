				...
				<table class="table table-striped table-bordered"><caption>Uren</caption>
					<thead>
						...
						<tr>
							...
							<th scope="col" class="hidden-xs"><a href="" ng-click="sortType = 'rol'">Rol</a>
								<a href="" ng-click="sortReverse = !sortReverse"> <span
							...
							<th scope="col" class="hidden-xs hidden-sm hidden-md">Start</th>
							<th scope="col" class="hidden-xs hidden-sm hidden-md">Eind</th>
							<th scope="col">Aantal</th>
							<th scope="col"><a href="" ng-click="sortType = 'akkoord'">Akkoord</a> <a
